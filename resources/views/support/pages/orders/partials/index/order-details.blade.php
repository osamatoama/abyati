            ...
            <div class="d-flex flex-column gap-2">
                ...
                @if(filled($order->admin_url))
                    <div class="d-flex align-items-center gap-2">
                        ...
                        <a href="{{ $order->admin_url }}" class="text-muted text-hover-primary">{{ __('support.orders.attributes.admin_url') }}</a>
                    </div>
                @endif
                ...
                @if(filled($order->customer_url))
                    <div class="d-flex align-items-center gap-2">
                        ...
                        <a href="{{ $order->customer_url }}" class="text-muted text-hover-primary">{{ __('support.orders.attributes.customer_url') }}</a>
                    </div>
                @endif
            </div>
        </div>
        ...
        <ul class="nav nav-custom nav-tabs nav-line-tabs nav-line-tabs-2x fs-6 fw-semibold mt-6 mb-8 gap-2" role="tablist">
            <li class="nav-item" role="presentation">
                <a class="nav-link text-active-primary d-flex align-items-center pb-4 active" data-bs-toggle="tab" href="#order-details-items" aria-selected="true" role="tab">
                    ...
                    {{ __('support.orders.attributes.items') }}
                </a>
            </li>
            ...
            <li class="nav-item" role="presentation">
                <a class="nav-link text-active-primary d-flex align-items-center pb-4" data-bs-toggle="tab" href="#order-details-customer" aria-selected="true" role="tab">
                    ...
                    {{ __('support.orders.attributes.customer') }}
                </a>
            </li>
            ...
            <li class="nav-item" role="presentation">
                <a class="nav-link text-active-primary d-flex align-items-center pb-4" data-bs-toggle="tab" href="#order-details-calculations" aria-selected="true" role="tab">
                    ...
                    {{ __('support.orders.calculations') }}
                </a>
            </li>
            ...
            <li class="nav-item" role="presentation">
                <a class="nav-link text-active-primary d-flex align-items-center pb-4" data-bs-toggle="tab" href="#order-details-history" aria-selected="true" role="tab">
                    ...
                    {{ __('support.orders.history.title') }}
                </a>
            </li>
            ...
            <li class="nav-item" role="presentation">
                <a class="nav-link text-active-primary d-flex align-items-center pb-4" data-bs-toggle="tab" href="#order-details-address" aria-selected="true" role="tab">
                    ...
                    {{ $order->isPickup() ? __('support.orders.address.attributes.pickup_address') : __('support.orders.address.attributes.shipping_address') }}
                </a>
            </li>
        </ul>
        ...
        <div class="tab-content" id="">
            <div class="tab-pane fade show active" id="order-details-items" role="tabpanel">
                <table class="table table-row-bordered">
                    <thead>
                        <tr>
                            <th>{{ __('support.orders.items.attributes.product') }}</th>
                            <th>{{ __('support.orders.items.attributes.barcode') }}</th>
                            <th>{{ __('support.orders.items.attributes.quantity') }}</th>
                            <th>{{ __('support.orders.items.attributes.unit_price') }}</th>
                            <th>{{ __('support.orders.items.attributes.total') }}</th>
                        </tr>
                    </thead>
            ...
            <div class="tab-pane fade" id="order-details-customer" role="tabpanel">
                <table class="table fit-content-table">
                    <tbody>
                        <tr>
                            <th class="fw-semibold">{{ __('support.customers.attributes.name') }}</th>
                            <td>{{ $order->customer_name }}</td>
                        </tr>

                        <tr>
                            <th class="fw-semibold">{{ __('support.customers.attributes.email') }}</th>
                            <td>{{ $order->customer['email'] ?? '---' }}</td>
                        </tr>

                        <tr>
                            <th class="fw-semibold">{{ __('support.customers.attributes.mobile') }}</th>
                            <td>
                                <span dir="ltr">
                        ...
                        <tr>
                            <th class="fw-semibold">{{ __('support.customers.attributes.city') }}</th>
                            <td>{{ $order->customer['city'] ?? '---' }}</td>
                        </tr>

                        <tr>
                            <th class="fw-semibold">{{ __('support.customers.attributes.country') }}</th>
                            <td>{{ $order->customer['country'] ?? '---' }}</td>
                        </tr>

                        <tr>
                            <th class="fw-semibold">{{ __('support.customers.attributes.currency') }}</th>
            ...
            <div class="tab-pane fade" id="order-details-history" role="tabpanel">
                <table class="table">
                    <thead class="fw-bold">
                        <tr>
                            <th>{{ __('support.orders.history.attributes.status') }}</th>
                            <th>{{ __('support.orders.history.attributes.note') }}</th>
                            <th>{{ __('support.orders.history.attributes.date') }}</th>
                        </tr>
                    </thead>
            ...
            <div class="tab-pane fade" id="order-details-address" role="tabpanel">
                ...
                @else
                    <p class="text-muted">
                        {{ __('support.orders.messages.no_shipping_address') }}
                    </p>
                @endif
            </div>
        </div>
