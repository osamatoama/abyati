...
@section('title', __('support.reports.title'))

@section('content')
    <div class="row">
        <div class="col-md-3">
            <a href="{{ route('support.reports.products-without-sku.index') }}" class="card hover-elevate-up shadow-sm parent-hover mb-5">
                <div class="card-body d-flex align-items-center">
                    ...
                    <span class="ms-3 text-gray-700 parent-hover-primary fs-6 fw-bold">
                        {{ __('support.reports.products_without_sku.title') }}
                    </span>
                </div>
            </a>
        </div>
