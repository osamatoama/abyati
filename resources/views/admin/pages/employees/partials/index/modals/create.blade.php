<div class="modal fade" id="create-modal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
            <form id="create-form" action="{{ route("admin.employees.store") }}" autocomplete="off">
                <div class="modal-header">
                    <h5 class="modal-title">
                        {{ __('admin.employees.action.create') }}
                    </h5>
                ...
                <div class="modal-body">
                    <div class="form-group mt-3 row">
                        ...
                        <div class="col-md-10">
                            <input type="text" name="name" id="create-form-name" placeholder="{{ __('admin.employees.attributes.name') }}"
                                class="form-control">
