<div class="modal fade" id="attach-product-modal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
            <form id="attach-product-form" action="{{ route('admin.shelves.products.attach', ['shelf' => $shelf->id]) }}" autocomplete="off">
                <div class="modal-header">
                    <h5 class="modal-title">
                        {{ __('admin.shelves.actions.attach_product') }}
                    </h5>
                ...
                <div class="modal-body">
                    <div class="form-group mt-3 row">
                        <label for="attach-product-form-product_ids" class="col-md-2 form-label form-control-lg">{{ __('admin.products.title') }}</label>

                        <select
                            id="attach-product-form-product_ids" class="form-select form-select-solid attach-product-form-product_ids"
                            name="product_ids[]"
                            data-ajax-url="{{ route('admin.products.select') }}"
