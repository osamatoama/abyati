<div class="modal fade" id="import-modal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
            <form id="import-form" action="{{ route('admin.shelves.import') }}" autocomplete="off" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group mt-3 row">
                        <label for="import-form-warehouse_id" class="col-md-2 form-label form-control-lg">{{ __('admin.shelves.attributes.warehouse') }}</label>

                        <div class="col-md-10">
                            <select name="warehouse_id" id="import-form-warehouse_id" class="form-control">
                            ...
                            <span id="import-form-warehouse_id-error" class="form-input-error text-danger d-none"></span>
                        </div>
                    </div>
                    ...
                    <div class="form-group mt-3 row">
                        ...
                        <div class="col-md-10">
                            <input id="import-form-file" type="file" class="form-control import-form-file" name="file" />

                            <span id="import-form-file-error" class="form-input-error text-danger d-none">
                        </div>
                    </div>
                </div>
