<form wire:submit.prevent="apply">
    <div class="mb-10" wire:ignore>
        <label class="form-label">{{ __('support.orders.attributes.store') }}</label>
    ...
    <div class="mb-10" wire:ignore>
        <div class="col-12 mb-5">
            <label class="form-label">{{ __('support.orders.attributes.date') }}</label>
    ...
    <div class="mb-10" wire:ignore>
        <label class="form-label">{{ __('support.orders.attributes.completion_status') }}</label>
