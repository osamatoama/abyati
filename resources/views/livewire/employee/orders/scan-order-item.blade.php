                    ...
                    <form wire:submit.prevent="scan">
                        ...
                        <div class="mb-10">
                            ...
                            <div class="col-12 mb-5">
                                ...
                                {{-- <input type="text" class="scan-item-barcode-input form-control @error('scanned_barcode') is-invalid @enderror" wire:model="scanned_barcode" /> --}}
                                <input type="text" class="scan-item-barcode-input form-control @error('scanned_barcode') is-invalid @enderror" wire:model="scanned_barcode" wire:keyup.throttle.500ms="scan" />
