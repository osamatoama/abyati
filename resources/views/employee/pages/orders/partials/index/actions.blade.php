<livewire:employee.orders.export-orders />
            ...
            @if(can('orders.edit'))
                <li>
                    <a href="javascript:void(0)" class="dropdown-item" data-bs-toggle="modal" data-bs-target="#pull-orders-modal">
                        <i class="fas fa-download me-1"></i> <span class="me-3">{{ __('employee.orders.pull_form.pull_orders') }}</span>
                    </a>
                </li>
            @endif
        </ul>
...
<x-employee.actions.filter-drawer>
    <livewire:employee.orders.filter-orders />
</x-employee.actions.filter-drawer>
