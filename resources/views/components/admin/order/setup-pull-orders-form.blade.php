                    ...
                    <div class="modal-body">
                        <div class="form-group row">
                            <div class="col-12 mb-5">
                                <label for="pull-orders-form-orders_count" class="form-label">{{ __('admin.orders.pull_form.orders_count') }}</label>
                            ...
                            <div class="col-12 mb-5">
                                <label for="pull-orders-form-to_date" class="form-label">{{ __('admin.orders.pull_form.to_date') }}</label>
