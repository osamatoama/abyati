...
class ShelfSyncProductsIndex extends Datatable
{
    ...
    protected function addColumns(): array
    {
        return [
            'checkbox' => function (Product $product) {
                $shelf = $this->shelf;
                return view('employee.pages.shelves.partials.sync.cols.checkbox', compact('product', 'shelf'));
            },
            'image' => function (Product $product) {
                return view('employee.pages.shelves.partials.sync.cols.image', compact('product'));
            },
            'attached_at' => function (Product $product) {
                $attachedAt = Carbon::parse($product->attached_at);

                return view('employee.pages.shelves.partials.sync.cols.attached_at', compact('product', 'attachedAt'));
            },
        ];
    }
    ...
    public function editColumns(): array
    {
        return [
            'id' => function (Product $product) {
                return view('employee.pages.shelves.partials.sync.cols.id', compact('product'));
            },
            'remote_id' => function (Product $product) {
                return view('employee.pages.shelves.partials.sync.cols.remote_id', compact('product'));
            },
            'name' => function (Product $product) {
                return view('employee.pages.shelves.partials.sync.cols.name', compact('product'));
            },
            'sku' => function (Product $product) {
                return view('employee.pages.shelves.partials.sync.cols.sku', compact('product'));
            },
            'quantity' => function (Product $product) {
                return view('employee.pages.shelves.partials.sync.cols.quantity', compact('product'));
            },
            'synced' => function (Product $product) {
                return view('employee.pages.shelves.partials.sync.cols.synced', compact('product'));
            },
        ];
    }
