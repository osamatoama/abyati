...
class FilterOrders extends Component
{
    ...
    {
        return view('livewire.employee.orders.filter-orders');
    }
    ...
    public function apply()
    {
        ...
        $this->dispatch('order-filters-applied', [
            ...
            'refresh_url' => route('employee.orders.index', $this->getFilters()),
        ]);
    }
    ...
    public function resetFilters()
    {
        ...
        $this->dispatch('order-filters-reset', [
            'filters' => [],
            'refresh_url' => route('employee.orders.index'),
        ]);
    }
    ...
    {
        return [
            // 'store_id' => __('employee.orders.pull_form.store'),
            'from_date' => __('employee.orders.pull_form.from_date'),
            'to_date' => __('employee.orders.pull_form.to_date'),
        ];
    }
    ...
    {
        return [
            'from_date.before_or_equal' => __('employee.orders.pull_form.errors.from_date_should_be_before_now'),
            'to_date.before_or_equal' => __('employee.orders.pull_form.errors.to_date_should_be_before_now'),
            'to_date.after_or_equal' => __('employee.orders.pull_form.errors.to_date_should_be_after_from_date'),
        ];
    }
