...
class FilterShelves extends Component
{
    ...
    {
        return view('livewire.admin.shelves.filter-shelves');
    }
    ...
    public function apply()
    {
        ...
        $this->dispatch('shelf-filters-applied', [
            ...
            'refresh_url' => route('admin.shelves.index', $this->getFilters()),
        ]);
    }
    ...
    public function resetFilters()
    {
        ...
        $this->dispatch('shelf-filters-reset', [
            'filters' => [],
            'refresh_url' => route('admin.shelves.index'),
        ]);
    }
    ...
    {
        return [
            'warehouse_ids' => __('admin.shelves.attributes.warehouse'),
        ];
    }
